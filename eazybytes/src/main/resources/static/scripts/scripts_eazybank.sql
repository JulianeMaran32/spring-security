...
-- CRIA TABELAS
CREATE TABLE eazybank.customers
(
...
CREATE TABLE eazybank.accounts
(
    ...
    CONSTRAINT `customer_ibfk_1` FOREIGN KEY (`customer_id`) REFERENCES eazybank.customers (`customer_id`) ON DELETE CASCADE
);

CREATE TABLE eazybank.account_transactions
(
    ...
    CONSTRAINT `accounts_ibfk_2` FOREIGN KEY (`account_number`) REFERENCES eazybank.accounts (`account_number`) ON DELETE CASCADE,
    CONSTRAINT `acct_user_ibfk_1` FOREIGN KEY (`customer_id`) REFERENCES eazybank.customers (`customer_id`) ON DELETE CASCADE
);

CREATE TABLE eazybank.loans
(
    ...
    KEY `customer_id` (`customer_id`),
    CONSTRAINT `loan_customer_ibfk_1` FOREIGN KEY (`customer_id`) REFERENCES eazybank.customers (`customer_id`) ON DELETE CASCADE
);

CREATE TABLE eazybank.cards
(
    ...
    PRIMARY KEY (`card_id`),
    KEY `customer_id` (`customer_id`),
    CONSTRAINT `card_customer_ibfk_1` FOREIGN KEY (`customer_id`) REFERENCES eazybank.customers (`customer_id`) ON DELETE CASCADE
);

CREATE TABLE eazybank.notice_details
(
...
CREATE TABLE eazybank.contact_messages
(
...
VALUES (UUID(), 1865764534, 1, DATE_SUB(CURDATE(), INTERVAL 7 DAY), 'Coffee Shop', 'Withdrawal', 30, 34500,
       ...
       (UUID(), 1865764534, 1, DATE_SUB(CURDATE(), INTERVAL 6 DAY), 'Uber', 'Withdrawal', 100, 34400,
        DATE_SUB(CURDATE(), INTERVAL 6 DAY)),
       (UUID(), 1865764534, 1, DATE_SUB(CURDATE(), INTERVAL 5 DAY), 'Self Deposit', 'Deposit', 500, 34900,
        DATE_SUB(CURDATE(), INTERVAL 5 DAY)),
       (UUID(), 1865764534, 1, DATE_SUB(CURDATE(), INTERVAL 4 DAY), 'Ebay', 'Withdrawal', 600, 34300,
        DATE_SUB(CURDATE(), INTERVAL 4 DAY)),
       (UUID(), 1865764534, 1, DATE_SUB(CURDATE(), INTERVAL 2 DAY), 'OnlineTransfer', 'Deposit', 700, 35000,
        DATE_SUB(CURDATE(), INTERVAL 2 DAY)),
       (UUID(), 1865764534, 1, DATE_SUB(CURDATE(), INTERVAL 1 DAY), 'Amazon.com', 'Withdrawal', 100, 34900,
...
INSERT INTO eazybank.notice_details (`notice_summary`, `notice_details`, `notic_beg_dt`, `notic_end_dt`, `create_dt`,
                                     `update_dt`)
